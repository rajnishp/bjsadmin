...
<head>
    ...
    <link href="<?= $this-> baseUrl ?>static/plugins/animate-css/animate.min.css" rel="stylesheet">


    <!--Morris.js [ OPTIONAL ]-->
    <link href="<?= $this-> baseUrl ?>static/<?= $this-> baseUrl ?>static/plugins/morris-js/morris.min.css" rel="stylesheet">
...
<body>
    ...
    <!--Morris.js [ OPTIONAL ]-->
    <script src="<?= $this-> baseUrl ?>static/plugins/morris-js/morris.min.js"></script>
    <script src="<?= $this-> baseUrl ?>static/plugins/morris-js/raphael-js/raphael.min.js"></script>


    <!--Sparkline [ OPTIONAL ]-->
    <script src="<?= $this-> baseUrl ?>static/plugins/sparkline/jquery.sparkline.min.js"></script>


    <!--Skycons [ OPTIONAL ]-->
    <script src="<?= $this-> baseUrl ?>static/plugins/skycons/skycons.min.js"></script>
    ...
    <!--Specify page [ SAMPLE ]-->
    <script src="<?= $this-> baseUrl ?>static/js/demo/dashboard.js"></script>
