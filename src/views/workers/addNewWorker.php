...
<head>
	...
	<title>Form Components | Nifty - Responsive admin template.</title>
	...
	<!--Switchery [ OPTIONAL ]-->
	<link href="<?= $this-> baseUrl ?>static/plugins/switchery/switchery.min.css" rel="stylesheet">


	<!--Bootstrap Select [ OPTIONAL ]-->
	<link href="<?= $this-> baseUrl ?>static/plugins/bootstrap-select/bootstrap-select.min.css" rel="stylesheet">


	<!--Bootstrap Tags Input [ OPTIONAL ]-->
	<link href="<?= $this-> baseUrl ?>static/plugins/bootstrap-tagsinput/bootstrap-tagsinput.css" rel="stylesheet">


	<!--Chosen [ OPTIONAL ]-->
	<link href="<?= $this-> baseUrl ?>static/plugins/chosen/chosen.min.css" rel="stylesheet">


	<!--noUiSlider [ OPTIONAL ]-->
	<link href="<?= $this-> baseUrl ?>static/plugins/noUiSlider/jquery.nouislider.min.css" rel="stylesheet">
	<link href="<?= $this-> baseUrl ?>static/plugins/noUiSlider/jquery.nouislider.pips.min.css" rel="stylesheet">


	<!--Bootstrap Timepicker [ OPTIONAL ]-->
	<link href="<?= $this-> baseUrl ?>static/plugins/bootstrap-timepicker/bootstrap-timepicker.min.css" rel="stylesheet">


	<!--Bootstrap Datepicker [ OPTIONAL ]-->
	<link href="<?= $this-> baseUrl ?>static/plugins/bootstrap-datepicker/bootstrap-datepicker.css" rel="stylesheet">


	<!--Dropzone [ OPTIONAL ]-->
	<link href="<?= $this-> baseUrl ?>static/plugins/dropzone/dropzone.css" rel="stylesheet">


	<!--Summernote [ OPTIONAL ]-->
	<link href="<?= $this-> baseUrl ?>static/plugins/summernote/summernote.min.css" rel="stylesheet">
			...
			<div id="content-container">
				...
				<form class="form-horizontal" id="worker_details_form" onsubmit="return (validateWorkerDetails());">
				    ...
				    <div class="form-group">
				      	...
				      	<label class="col-md-3 control-label">Current Working Area</label>
				    ...
				    <div class="form-group">
				      	...
				      	<label class="col-md-3 control-label">Preferred Working Area</label>
